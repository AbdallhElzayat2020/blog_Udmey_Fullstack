                ...
                <form action="{{route('admin.category.update', $category->id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="show_at_navbar" id="show_at_navbar" class="form-control">
                            <option value="{{$category->show_at_nav === 1 ?'selected' : ''}}">Yes</option>
                            <option value="{{$category->show_at_nav === 0 ?'selected' : ''}}">No</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control">
                            ...
                            <option value="{{$category->status == 0 ?'selected' : ''}}">In Active</option>
                        </select>
                        @error('status')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
